  ...
  return (
    ...
    <div className="grid grid-cols-2 gap-4 md:grid-cols-2 pb-4 lg:grid-cols-5" id="aboutgrid">
      ...
      <div className="col-span-2 md:col-span-2 lg:col-span-3">
        <h1 className="text-5xl font-semibold">About Rajasthali Resort and Spa</h1>
    ...
    <div className="grid grid-cols-2 max-w-5xl mx-auto md:grid-cols-2 mt-20 lg:grid-cols-3 gap-4">
